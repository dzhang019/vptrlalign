...
def render_and_record(env, agent, out, frame_width, frame_height):
    """
    ...
    Args:
        ...
        start_time: Start time for tracking elapsed seconds.
...
def main(model, weights):
    ...
    print("---Launching MineRL environment (be patient)---")
     #Start the timer for the time tracker
    stats = render_and_record(env, agent, out, frame_width, frame_height) #Call the function that handles all the overlay stuff

    #Include this stuff until next comment
    out.release()
    ...
    #End of new stuff to main() function
