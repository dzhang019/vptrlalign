...
def render_and_record(env, agent, out, frame_width, frame_height, tick_rate):
    """
    ...
    Args:
        ...
        tick_rate: Number of steps per render.
...
def main(model, weights, tick_rate):
    ...
    stats = render_and_record(env, agent, out, frame_width, frame_height, tick_rate)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tick_rate", type=int, default=1, help="Number of steps per render.")
    args = parser.parse_args()
    main(args.model, args.weights, args.tick_rate)
